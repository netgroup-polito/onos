...
public class OpenconfigBgpManager extends AbstractYangServiceImpl implements OpenconfigBgpNetconfService {
    ...
    public static final String OPENCONFIG_BGP = "org.onosproject.drivers.examplenetconfdriver.yang.openconfigbgp";
    public static final String OPENCONFIG_BGP_NS = "http://www.examplenetconfdriver.com/openconfigbgp";
